...
步骤流程是：安装安装器主体→下载或安装Cts套件→重启→授权安装未知与应用文件访问权限→找到Download文件夹→找到包体即可开始安装。看不懂流程，或不会可以看开发者的[置顶笔记](https://notes.qoo-app.com/note/3339469)如果上不去的复制这个笔记ID数字“3339469”然后打开qoo搜索粘贴就可以搜到这个笔记
